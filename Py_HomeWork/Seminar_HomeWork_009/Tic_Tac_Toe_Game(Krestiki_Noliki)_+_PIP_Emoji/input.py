...
def user_name_1():
    ...
    print(emoji.emojize('Отлично ты играешь за крестики: :cross_mark:'))
    return name


def user_name_2():
    name = input('Твой ник игрок №2?: ')
    print(emoji.emojize('Ну а тебе достаются нолики: :hollow_red_circle:'))
    return name
...
def user_symbol(who_gamer):
    if who_gamer == 'user_1':
        ...
        return emoji.emojize(':hollow_red_circle:')
